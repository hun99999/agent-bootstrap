...
- identify whether this task affects the shared core, Codex adapter, Claude Code plugin renderer, docs, tests, skills, or copy-paste prompts
...
- OpenCode/OpenClaw files are legacy/reference material and should be touched only when Hun explicitly asks for migration or restoration work
